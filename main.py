...
# ==============================================================================
VERSION_APP = "1.6 (Automatización de Perfiles y WhatsApp)"

# Enlace de la aplicación integrado
        ...
        if tiene_acceso_inventario:
            if not df_inv.empty:
                ...
                if not disponibles.empty:
                    ...
                    st.warning("No hay cupos en el inventario automático.")
            ...
            st.info("Ingresa los datos de la cuenta asignada a este cliente.")
            with ca: mv = st.text_input("Correo")
            ...
            with st.form("form_crear_vend"):
                ...
                if st.form_submit_button("Crear Perfil y Generar Clave", type="primary", use_container_width=True):
                    if nuevo_nom and nuevo_tel:
                        ...
                        st.warning("⚠️ Debes llenar el Nombre y el Teléfono.")
